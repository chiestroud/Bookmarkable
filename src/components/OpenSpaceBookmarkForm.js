...
import { addPublicBookmark } from '../helpers/data/openSpaceData';

export default function OpenSpaceBookmarkForm({ publicCategory }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    addPublicBookmark().then((response) => console.warn(response));
  };
